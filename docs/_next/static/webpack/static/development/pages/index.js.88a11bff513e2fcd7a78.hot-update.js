...
function FetchApiExample() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Example, {
    ...
    code: ["import React from 'react';", "import InlineWorker from 'react-inline-worker';", "", "onmessage = function({ data }) {", "  function fn(){", "", "    fetch('https://api.ipify.org?format=json')", "      .then(result => result.json())", "      .then(data => {", "        postMessage(data);", "      })", "      .catch(err => {", "        postMessage(err);", "      });", "  }", "}"],
...
//# sourceMappingURL=index.js.88a11bff513e2fcd7a78.hot-update.js.map