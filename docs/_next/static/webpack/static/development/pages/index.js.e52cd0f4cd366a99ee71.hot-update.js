...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    code: ["import React from 'react';", "import InlineWorker from 'react-inline-worker';", "", "function HelloWorldExample(){", "  function fn(){", "    postMessage('Hello world!');", "  }", "  return <InlineWorker fn={fn}>{() => {}}</InlineWorker>;", "}", "", "export default HelloWorldExample;"].join('\n'),
    result: "ahaight",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 55
...
//# sourceMappingURL=index.js.e52cd0f4cd366a99ee71.hot-update.js.map