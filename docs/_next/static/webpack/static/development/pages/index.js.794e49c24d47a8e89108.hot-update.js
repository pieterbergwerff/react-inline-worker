...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    code: ["import React from 'react';", "import InlineWorker from 'react-inline-worker';", "", "function HelloWorldExample(){", "  function fn(){", "    postMessage('Hello world!');", "  }", "  return <InlineWorker fn={fn}>{({ loading, error, data }) => {", "    if (loading) return 'loading...';", "    console.log(data); // Hello world!", "    return <div>Message from worker: {data}</div>;", "  }}</InlineWorker>;", "}", "", "export default HelloWorldExample;"].join('\n'),
...
//# sourceMappingURL=index.js.794e49c24d47a8e89108.hot-update.js.map