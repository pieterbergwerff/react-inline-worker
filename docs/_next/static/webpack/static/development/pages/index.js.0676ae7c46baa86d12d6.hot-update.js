...
function FetchApiExample() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Example, {
    ...
    code: ["import React from 'react';", "import InlineWorker from 'react-inline-worker';", "", "function fn(){", "  fetch('https://api.ipify.org?format=json')", "    .then(result => result.json())", "    .then(data => {", "      postMessage(data);", "    })", "    .catch(err => {", "      postMessage(err);", "    });", "}", ""],
...
//# sourceMappingURL=index.js.0676ae7c46baa86d12d6.hot-update.js.map