...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    description: "Use the worker to receive a simple 'Hello world!'",
    code: ["import React from 'react';", "import InlineWorker from 'react-inline-worker';", "", "function HelloWorldExample(){", "  function fn(){", "    postMessage('Hello world!');", "  }", "  return <InlineWorker fn={fn}>{({ loading, error, data }) => {", "    console.log(data); // Hello world!", "    return data;", "  }}</InlineWorker>;", "}", "", "export default HelloWorldExample;"].join('\n'),
  ...
  _createClass(Example, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        message: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(RunComponent, {
...
//# sourceMappingURL=index.js.f907fba1e41c06942bd0.hot-update.js.map