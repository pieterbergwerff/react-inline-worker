...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    code: ["import React from 'react';", "import InlineWorker from 'react-inline-worker';", "", "function HelloWorldExample(){", "  function fn(){", "    postMessage('Hello world!');", "  }", "  return <InlineWorker fn={fn}>{({ loading, error, data }) => {", "    console.log(data); // Hello world!", "    return false;", "  }}</InlineWorker>;", "}", "", "export default HelloWorldExample;"].join('\n'),
  ...
  _createClass(Example, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        __self: this
      }, running ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_2__["Icon"], {
        type: "loading",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 141
...
//# sourceMappingURL=index.js.798c2525052f9171b5c9.hot-update.js.map