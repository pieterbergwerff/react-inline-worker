...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    code: ["import React from 'react';", "import InlineWorker from 'react-inline-worker';", "", "function HelloWorldExample(){", "  function fn(){", "    postMessage('Hello world!');", "  }", "  return <InlineWorker fn={fn}>{({ loading, error, data }) => {", "    console.log(data); // Hello world!", "  }}</InlineWorker>;", "}", "", "export default HelloWorldExample;"].join('\n'),
...
//# sourceMappingURL=index.js.357737bc2819add7f0da.hot-update.js.map