...
function FetchApiExample() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Example, {
    ...
    code: ["import React from 'react';", "import InlineWorker from 'react-inline-worker';", "", "function fn(){", "  onmessage = function({ data }) {", "", "    fetch('https://api.ipify.org?format=json')", "      .then(result => result.json())", "      .then(data => {", "        postMessage(data);", "      })", "      .catch(err => {", "        postMessage(err);", "      });", "  }", "}"],
...
//# sourceMappingURL=index.js.3b8d73d37d7854787fd9.hot-update.js.map