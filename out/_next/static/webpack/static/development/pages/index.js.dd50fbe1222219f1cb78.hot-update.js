...
function FetchApiExample() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Example, {
    ...
    code: ["import React from 'react';", "import InlineWorker from 'react-inline-worker';", "", "function fn(){", "  onmessage = function({ data }) {", "    fetch(data.url)", "      .then(result => result.json())", "      .then(data => {", "        postMessage(data);", "      })", "      .catch(err => {", "        postMessage(err);", "      });", "  }", "}"],
...
//# sourceMappingURL=index.js.dd50fbe1222219f1cb78.hot-update.js.map