...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    code: ["import React from 'react';", "import InlineWorker from 'react-inline-worker';", "", "function HelloWorldExample(){", "  function fn(){", "    postMessage('Hello world!');", "  }", "  return <InlineWorker fn={HelloWorldExample}>{({ data }) => {", "    console.log(data); // Hello world!", "  }}</InlineWorker>;", "}", "", "export default HelloWorldExample;"].join('\n'),
    result: "ahaight",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 55
...
//# sourceMappingURL=index.js.71e2f762710b2b1154d9.hot-update.js.map