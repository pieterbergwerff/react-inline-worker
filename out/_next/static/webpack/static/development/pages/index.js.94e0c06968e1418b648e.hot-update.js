...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    code: ["import React from 'react';", "import InlineWorker from 'react-inline-worker';", "", "function HelloWorldExample(){", "  function fn(){", "    postMessage('Hello world!');", "  }", "  return <InlineWorker>{() => {}}</InlineWorker>;", "}", "", "export default HelloWorldExample;"].join('\n'),
    result: "ahaight",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 55
...
//# sourceMappingURL=index.js.94e0c06968e1418b648e.hot-update.js.map